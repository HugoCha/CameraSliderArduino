...
const char PROGMEM option_menu_item0[]="Battery";
...
const char PROGMEM * const option_menu_items[] = {option_menu_item0, option_menu_item00, option_menu_item01, option_menu_item02, option_menu_item03, option_menu_item04};
